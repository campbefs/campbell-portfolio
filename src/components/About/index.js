  ...
  return (
    <section className='about-body'>
      ...
      <p className="about-text">
        I am a full-stack web developer & data analyst interested in mastering the latest tools and technologies. I currently work for Facebook and have previously worked at Wayfair and Liberty Mutual.
        <br/>
        <br/>
